    ...
    <div class="row">
      <div class="col">
        <div class="text-center">
          <a class="btn btn-danger btn-block btn-lg mb-2" href="/privade/views/session/HomeAD.php" role="button">Atrás</a>
        </div>
        <div class="mt-3">
  ...
  <title>SENA_HORAS_TRABAJO</title>
    ...
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
      <div class="row">
        <div class="col">
          <div class="text-center">
            <a class="btn btn-danger btn-block btn-lg mb-2" href="/privade/views/session/home1.php" role="button">Atrás</a>
          </div>
          <div class="mt-3">
            <label for="contraseña1" class="d-flex justify-content-center">CONTRASEÑA</label>
            <input type="password" class="form-control" id="contraseña1" name="contraseña1" placeholder="CONTRASEÑA" required>
